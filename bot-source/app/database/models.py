...
class User(Base):
    ...
    # Реферальный pending bonus в днях — плюсуется к следующей покупке инвайтера, если в момент начисления нет активной подписки
    pending_bonus_days = Column(Integer, nullable=False, server_default="0")
...
class SentNotification(Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            'minutes_before',
            'expires_at',
            name='uq_sent_notifications_subscription_expiry',
        ),
    )
