...
class MenuLayoutService:
    ...
    @staticmethod
    def _is_main_menu_language_button(button_id: str, button_config: dict[str, Any]) -> bool:
        return (
            button_id == 'language'
            or button_config.get('builtin_id') == 'language'
            or button_config.get('action') == 'menu_language'
        )
    ...
    async def build_keyboard(
        ...
        for row_config in rows_config:
            ...
            for button_id in row_config.get('buttons', []):
                ...
                if cls._is_main_menu_language_button(button_id, button_cfg):
                    continue
