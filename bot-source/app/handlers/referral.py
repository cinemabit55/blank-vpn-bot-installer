...
async def show_referral_info(callback: types.CallbackQuery, db_user: User, db: AsyncSession):
    ...
    # TZ Templar VPN: статистика очищена от рублёвых метрик; блок наград переписан под механику дней
    referral_text = (
        ...
        + '\n\n'
        + texts.t(
            'REFERRAL_REWARDS_TEMPLAR',
            (
                '🎁 <b>Как это работает:</b>\n'
                '• Друг получает <b>скидку 15%</b> на первую оплату\n'
                '• Вам — <b>+5 дней</b> подписки за первую оплату друга\n'
                '• Вам — <b>+10% дней</b> от срока каждой следующей покупки друга'
            ),
        )
        + '\n\n'
    )
    ...
    # TZ Templar VPN: футер «📢 Приглашайте друзей и зарабатывайте!» убран с экрана партнёрки
