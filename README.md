...
- Node profiles generated with TCP REALITY by default, server keepalive, WARP routing, RU-direct routing, direct UDP for reliable voice, and optional selective transit through another node
